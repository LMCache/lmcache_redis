...
python RESP-py-bench.py --size-mb 32 --num-chunks 100 --read --client-type custom --concurrency-level 4
Using Custom Zero-Copy Client (Threaded Wrapper)
Generating 100 chunks of 32MB...
--- Starting Read Test ---
Read 3.12 GB in 2.64s | Speed: 1.18 GB/s
python RESP-py-bench.py --size-mb 32 --num-chunks 100 --read --client-type redis-py
